...
export default function UchinokoKinenbiPage() {
  ...
  return (
    <InfoPage eyebrow="ANNIVERSARY FILM" title="うちの子記念日を、これからも見返せる映像に。" lead="家族になった日、初めて眠った場所、いつもの散歩道。出会った頃から今までの写真を、その子らしい物語として残します。">
      ...
      <section><h2>特別な一日だけでなく、そこまでの日々を残す</h2><p>WAN MEMORYの記念日動画は、ケーキや飾り付けの場面だけをつなぐものではありません。家族になった頃、好きになった場所、今の表情など、3つのエピソードから約1分の流れを組み立てます。写真ごとの毛の長さや年齢の違いも、成長の記録として丁寧に扱います。</p></section>
