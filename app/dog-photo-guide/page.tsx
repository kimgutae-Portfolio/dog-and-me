...
const faqs = [
  ["写真は最低何枚必要ですか？", "お顔・全身・横向きの基準写真3枚が必須です。思い出は3項目お聞きし、それぞれの場面写真は任意でお預かりします。"],
  ["HEIC形式の写真も送れますか？", "はい。iPhoneで撮影したHEIC写真は、アップロード時に制作で扱えるJPG形式へ変換します。"],
  ["家族と一緒に写った写真も使えますか？", "提出できます。人物のお顔は映像に使用・生成せず、後ろ姿などお顔が分からない形でのみ表現します。"],
] as const;
...
export default function DogPhotoGuidePage() {
  ...
  return (
    <InfoPage eyebrow="PHOTO GUIDE" title="愛犬の動画制作に適した、写真の選び方。" lead="枚数よりも大切なのは、顔・毛色・体型と、その場面らしさが分かること。外見を保ちやすい写真の基準をまとめました。">
      ...
      <section><h2>人物が写っている写真</h2><p>家族と一緒に写った写真も提出できます。ただしWAN MEMORYでは人物のお顔を映像に使用・生成しません。人物は後ろ姿・手元・足元・シルエットなど、お顔が分からない形でのみ表現します。写真に人物が写っている場合は、その方（未成年者の場合は保護者）の了解を得たうえでお送りください。</p></section>
