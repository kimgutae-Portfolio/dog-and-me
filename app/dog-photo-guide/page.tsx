...
const description =
  "愛犬が主人公になる動く絵本のための写真準備ガイド。3〜5つの物語ごとに、場面写真を迷わず選ぶ方法をご案内します。";
...
const faqs = [
  [
    "写真は最低何枚必要ですか？",
    "物語は最低3つです。物語ごとに同じ場面の写真が1枚必要なので、最低3枚をご用意ください。物語は最大5つ、写真は各物語3枚まで追加できます。",
  ],
  [
    "正面・全身・横向きは必要ですか？",
...
export default function DogPhotoGuidePage() {
  ...
  return (
    <InfoPage
      ...
      lead="正面・全身・横向きを揃える必要はありません。3〜5つの物語それぞれに、出来事と空気がいちばん伝わる写真を1枚選びます。"
    >
      <script
      ...
      <section>
        ...
        <ol className="seo-photo-list">
          ...
          <li>
            <span>02</span>
            <div>
              <strong>必要な時だけ補助写真</strong>
              <p>
                基準写真では見えない表情や小物がある場合だけ、あと2枚まで追加できます。追加しなくても問題ありません。
              </p>
            </div>
          </li>
          <li>
      ...
      <section>
        <h2>その出来事の写真がない場合</h2>
        <p>
          制作時の迷いを減らすため、現在は各物語に写真1枚を必須としています。写真が残っている出来事の中から、物語にしたい日を3つ選んでください。
        </p>
      </section>
      <section>
        <h2>人物が写っている場合</h2>
