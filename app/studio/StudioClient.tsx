...
export function StudioClient() {
  ...
  const nextAction = useMemo(() => {
    ...
    switch (order.status) {
      ...
      case "quality_check":
        return delivery
          ? { title: "完成映像を確認", copy: "映像を見て、気になる点があれば修正内容を送ってください。", href: "#delivery", label: "映像を確認する" }
