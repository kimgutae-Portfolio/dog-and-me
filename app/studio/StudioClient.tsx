...
export function StudioClient() {
  ...
  return (
    <main className="studio-page">
      <header className="studio-header"><Link className="brand" href="/"><span className="brand-mark" aria-hidden="true">き</span><span className="brand-type">きみとの映画<small>OUR PAW FILM</small></span></Link><nav><Link href="/">ホーム</Link><Link href="/story">新しい相談</Link><button type="button" aria-label="通知">○</button><span className="avatar">GT</span></nav></header>
