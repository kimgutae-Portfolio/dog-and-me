...
const homeFaqs = [
  ...
  [
    "送った写真は変更できますか？",
    "担当者の素材確認が終わるまでは、制作室から写真を追加・削除できます。確認完了後も、絵本ページの制作開始前であれば担当者へ変更をご相談いただけます。制作開始後は、進行状況により納期や追加費用をご案内する場合があります。",
  ],
  [
    "写真がそのまま動くのですか？",
          ...
          <ol className="process-list">
            {[
              ...
              [
                "04",
                "絵本ページと文章を確認する",
                "全場面の絵と、その場面に入る短い文章を先にお見せします。絵本ページは合計3場面まで修正できます。",
              ],
              [
                "05",
                "小さな動きを加える",
