...
const homeFaqs = [
  ["写真は何枚必要ですか？", "思い出を2〜6項目追加し、それぞれに同じ場面の写真を1〜5枚添えてください。写真は合計5枚以上、最大30枚までお送りいただけます。"],
  ...
  ["家族写真を映像に入れられますか？", "はい。大切なご家族写真は、AIで人物を動かさず、元のお写真をそのまま映像内で使用できます。お申し込み時に「元の家族写真をそのまま使用する」をお選びください。"],
  ["子どもが写った写真も送れますか？", "保護者の同意を得た写真のみお送りください。未成年者のお顔はAIで生成せず、愛犬だけを切り抜くか、お顔が分からない形、または元の写真を動かさない形で使用します。"],
  ["専用ウェブサイトとは何ですか？", "完成した映画、写真、メッセージをまとめたお客様専用ページです。制作室で表示する写真を整え、専用URLからいつでも見返せます。検索結果には掲載しません。"],
        ...
        <div className="shell">
          ...
          <ol className="process-list">
            {[
              ...
              ["07", "映画と専用サイトを受け取る", "完成映像と、その子だけのメモリーサイトを受け取り、専用URLからいつでも見返せます。"],
