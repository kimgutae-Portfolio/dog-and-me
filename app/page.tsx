...
const homeFaqs = [
  ...
  [
    "写真は何枚必要ですか？",
    "物語にしたい思い出を3〜5つ選び、それぞれに同じ場面の写真を1枚ご用意ください。別の表情や背景を補いたい物語だけ、写真を最大3枚まで追加できます。正面・全身・横向きのセットは必要ありません。",
  ],
  [
    "写真がそのまま動くのですか？",
  ...
  [
    "物語案2案とは何ですか？",
    "お預かりした3〜5つの思い出から、出来事をつなぐモチーフや物語の運び方が異なる2つのあらすじをご提案します。お好きな1案を選んでから料金をご案内します。",
  ],
  [
    "ナレーションは入りますか？",
        ...
        <div className="shell">
          ...
          <ol className="storybook-method-grid">
            <li>
              ...
              <p>
                初めての海、いつもの昼寝、忘れられない春。まず3つ、残したい出来事を選びます。
              </p>
            </li>
            <li>
              <span>02</span>
