...
const rows = [
  ...
  ["販売価格", "初期10組 ¥24,800（税込）／受付終了後 ¥29,800（税込）。表示価格には、場面イメージ調整2回と確認映像の修正2回が含まれます。追加対応が必要な場合は、お客様の同意前に内容と金額を個別に提示します。"],
  ["商品代金以外の費用", "インターネット接続・通信に必要な費用はお客様のご負担です。追加費用が発生する場合は契約前に明示します。"],
  ["お申し込み方法", "サイトの相談フォームから写真とエピソードを送信してください。内容確認後、制作室で確定料金、予定納期、お支払い方法をご案内します。相談フォームの送信だけでは料金は発生しません。"],
  ["販売数量・受付条件", "初期モニター価格は、必要な写真とエピソードの提出が完了した先着10組に適用します。1名で制作しているため、受付状況によって新規受付を一時停止する場合があります。"],
  ["支払方法", "クレジットカード決済（Stripe）。利用可能なカードブランドは決済画面に表示します。"],
  ["支払時期", "お申し込み内容、確定料金、予定納期、キャンセル条件をご確認いただいた後、制作開始前にお支払いいただきます。カード決済完了時に代金が確定します。"],
  ["役務の提供時期", "必要な素材が揃い、契約とお支払いが完了してから通常10〜14営業日を目安に、完成映像と専用メモリーサイトをオンラインで納品します。お客様の確認期間や修正内容により前後する場合は、契約前または制作室で予定日をご案内します。"],
  ["キャンセル・返金", "契約成立前および決済前のキャンセル料金はかかりません。決済後、制作着手前にキャンセルのご連絡をいただいた場合は全額返金します。制作着手後は、進行状況に応じて発生済みの制作費・外部サービス費を差し引いた金額を返金します。完成映像の確定・納品後は、当方の不備を除き返金できません。キャンセルは制作室のメッセージまたはメールでご連絡ください。"],
  ["制作物の不備", "納品内容が合意した仕様と異なる場合や、当方の不備により閲覧できない場合は、内容を確認のうえ再制作または修正を行います。解決できない場合は返金を含む対応をご案内します。"],
