...
// The output format is fixed: one warm live-action tone, 16:9, no narration,
// and BGM chosen by the director. Customers no longer pick these.
const FIXED_FILM_STYLE = "あたたかな実写風映像";
...
export function StoryWizard() {
  ...
  const missingFields = useMemo<MissingField[]>(() => {
    ...
    if (!draft.aiReconstructionAcknowledged) missing.push({ key: "aiReconstructionAcknowledged", label: "映像としての再構成についての確認", step: 3 });
    return missing;
