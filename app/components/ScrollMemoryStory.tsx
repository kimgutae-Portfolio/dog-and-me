...
const chapters = [
  ...
  },
  {
    ...
    title: "物語を、まずは",
    emphasis: "2つの物語案に。",
    copy: "5つの思い出と、その日の写真を物語の種にして、切り口の異なる2つの物語案をご提案します。心に近い1案を選んでいただき、絵本ページと文章を整えながら約40秒の動く絵本へ仕上げます。",
  ...
  },
  {
    ...
    title: "あなたは、",
    emphasis: "思い出を話すだけ。",
    copy: "生成AIの使い方を覚える必要はありません。物語案のご提案から絵本ページ、約40秒の完成動画、専用サイトの仕上げまでお任せください。大切な時間を、何度でも開ける物語にします。",
