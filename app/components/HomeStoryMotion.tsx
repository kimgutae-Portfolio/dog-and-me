...
const revealSelectors = [
  ...
  ".storybook-complete-includes > li",
  ".storybook-complete-site-preview",
  ".storybook-complete-site-copy > *",
  ".storybook-line-sticker-heading > *",
  ".storybook-line-sticker-preview",
  ".storybook-line-sticker-copy > *",
