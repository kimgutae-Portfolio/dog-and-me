-- The terms and AI reconstruction notice were materially updated on 2026-07-29.
-- Keep the privacy and people/photo consent versions unchanged, and require a
-- fresh customer acknowledgement for the updated terms and AI notice.
...
as $$
  select coalesce((
    ...
    and o.terms_version = '2026-07-29-style-v2'
    and o.privacy_version = '2026-07-27'
    and o.ai_notice_version = '2026-07-29-style-v2'
...
begin
  ...
  insert into public.orders (
    ...
    v_accepted_at, '2026-07-29-style-v2', '2026-07-27', v_accepted_at, '2026-07-29-style-v2', now() + interval '7 days', null, null, null,
  ...
  values (v_order_id, v_user_id, 'order_draft_created', jsonb_build_object(
    'quoted_price', v_regular_price, 'terms_version', '2026-07-29-style-v2', 'privacy_version', '2026-07-27',
    'ai_notice_version', '2026-07-29-style-v2', 'photo_rights_consent_version', '2026-07-25-photo-people-v2',
...
begin
  ...
  update public.orders set
    ...
    consented_at = v_accepted_at, terms_version = '2026-07-29-style-v2', privacy_version = '2026-07-27',
    external_ai_consent_at = v_accepted_at, ai_notice_version = '2026-07-29-style-v2',
  ...
  values (p_order_id, auth.uid(), 'order_draft_updated', jsonb_build_object(
    'terms_version', '2026-07-29-style-v2', 'privacy_version', '2026-07-27',
    'ai_notice_version', '2026-07-29-style-v2', 'photo_rights_consent_version', '2026-07-25-photo-people-v2',
    'people_policy_version', '2026-07-25-people-policy-v2'
  ));
end;
...
begin
  ...
  if p_terms_version is distinct from '2026-07-29-style-v2'
     or p_privacy_version is distinct from '2026-07-27'
     or p_ai_notice_version is distinct from '2026-07-29-style-v2' then
    raise exception 'current policy versions required';
  end if;
  if p_photo_rights_consent_version is distinct from '2026-07-25-photo-people-v2'
     or p_people_policy_version is distinct from '2026-07-25-people-policy-v2' then
    raise exception 'current consent text versions required';
  end if;
  update public.orders set
    consented_at = v_accepted_at, terms_version = p_terms_version, privacy_version = p_privacy_version,
...
revoke all on function public.order_has_current_consents(uuid) from public, anon;
revoke all on function public.create_memory_order(jsonb) from public, anon;
revoke all on function public.save_memory_order_draft(uuid, jsonb) from public, anon;
...
grant execute on function public.order_has_current_consents(uuid) to authenticated;
